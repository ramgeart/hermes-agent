...
metadata:
  hermes:
    ...
    homepage: https://github.com/ramgeart/hermes-neo
...
**Docs:** https://github.com/ramgeart/hermes-neo/docs/
...
Platform docs: https://github.com/ramgeart/hermes-neo/docs/user-guide/messaging/
...
authoritative list or see the [live slash commands reference](https://github.com/ramgeart/hermes-neo/docs/reference/slash-commands).
...
Full config reference: https://github.com/ramgeart/hermes-neo/docs/user-guide/configuration
...
Full provider docs: https://github.com/ramgeart/hermes-neo/docs/integrations/providers
...
User docs: https://github.com/ramgeart/hermes-neo/docs/user-guide/features/cron
...
User docs: https://github.com/ramgeart/hermes-neo/docs/user-guide/features/curator
...
User docs: https://github.com/ramgeart/hermes-neo/docs/user-guide/features/kanban
...
|----------------|----------|
| Config options | `hermes config edit` or [Configuration docs](https://github.com/ramgeart/hermes-neo/docs/user-guide/configuration) |
| Available tools | `hermes tools list` or [Tools reference](https://github.com/ramgeart/hermes-neo/docs/reference/tools-reference) |
| Slash commands | `/help` in session or [Slash commands reference](https://github.com/ramgeart/hermes-neo/docs/reference/slash-commands) |
| Skills catalog | `hermes skills browse` or [Skills catalog](https://github.com/ramgeart/hermes-neo/docs/reference/skills-catalog) |
| Provider setup | `hermes model` or [Providers guide](https://github.com/ramgeart/hermes-neo/docs/integrations/providers) |
| Platform setup | `hermes gateway setup` or [Messaging docs](https://github.com/ramgeart/hermes-neo/docs/user-guide/messaging/) |
| MCP servers | `hermes mcp list` or [MCP guide](https://github.com/ramgeart/hermes-neo/docs/user-guide/features/mcp) |
| Profiles | `hermes profile list` or [Profiles docs](https://github.com/ramgeart/hermes-neo/docs/user-guide/profiles) |
| Cron jobs | `hermes cron list` or [Cron docs](https://github.com/ramgeart/hermes-neo/docs/user-guide/features/cron) |
| Memory | `hermes memory status` or [Memory docs](https://github.com/ramgeart/hermes-neo/docs/user-guide/features/memory) |
| Env variables | `hermes config env-path` or [Env vars reference](https://github.com/ramgeart/hermes-neo/docs/reference/environment-variables) |
| CLI commands | `hermes --help` or [CLI reference](https://github.com/ramgeart/hermes-neo/docs/reference/cli-commands) |
...
For occasional contributors and PR authors. Full developer docs: https://github.com/ramgeart/hermes-neo/docs/developer-guide/

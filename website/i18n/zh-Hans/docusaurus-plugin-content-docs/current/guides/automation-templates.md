...
hermes cron create "0 2 * * *" \
  "You are a project manager triaging the ramgeart/hermes-neo GitHub repo.

1. Run: gh issue list --repo ramgeart/hermes-neo --state open --json number,title,labels,author,createdAt --limit 30
...
hermes cron create "0 9 * * 1" \
  "Scan the ramgeart/hermes-neo repo for documentation drift.

1. Run: gh pr list --repo ramgeart/hermes-neo --state merged --json number,title,files,mergedAt --limit 30

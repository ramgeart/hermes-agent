...
* Implementation: [`agent/plugin_llm.py`](https://github.com/ramgeart/hermes-neo/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/ramgeart/hermes-neo/blob/main/tests/agent/test_plugin_llm.py)

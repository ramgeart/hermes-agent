...
const config: Config = {
  ...
  url: 'https://github.com/ramgeart/hermes-neo',
  baseUrl: '/docs/',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/ramgeart/hermes-neo/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/ramgeart/hermes-neo',
          label: 'Home',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Discussions', href: 'https://github.com/ramgeart/hermes-neo/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/ramgeart/hermes-neo' },
